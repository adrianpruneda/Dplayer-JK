        ...
        function (e, t, a) {
            ...
            var n = a(15),
                ...
                r = {
                    ...
                    getElementViewLeft: function (e) {
                        ...
                        if (document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement) for (; null !== a && a !== e; ) (t += a.offsetLeft), (a = a.offsetParent);
            ...
            var p = function (e) {
                ...
                return (
                    ...
                    e.subtitle &&
                        (!e.subtitle.type && (e.subtitle.type = "webvtt"), !e.subtitle.fontSize && (e.subtitle.fontSize = "20px"), !e.subtitle.bottom && (e.subtitle.bottom = "40px"), !e.subtitle.color && (e.subtitle.color = "#fff")),
            ...
            var ie = (function () {
                function e(t) {
                    !(function (e, t) {
                        ...
                        (this.storageName = { opacity: "dplayer-danmaku-opacity", volume: "dplayer-volume", unlimited: "dplayer-danmaku-unlimited", danmaku: "dplayer-danmaku-show", subtitle: "dplayer-subtitle-show" }),
                        (this.default = { opacity: 0.7, volume: t.options.hasOwnProperty("volume") ? t.options.volume : 0.7, unlimited: (t.options.danmaku && t.options.danmaku.unlimited ? 1 : 0) || 0, danmaku: 1, subtitle: 1 }),
                        (this.data = {}),
                        this.init();
                }
                var t, a, n;
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.player.options.video.thumbnails &&
                                    ((this.thumbnails = new fe({ container: this.player.template.barPreview, barWidth: this.player.template.barWrap.offsetWidth, url: this.player.options.video.thumbnails, events: this.player.events })),
                                ...
                                this.player.template.volumeBarWrapWrap.addEventListener("click", function (t) {
                                    ...
                                    this.player.template.volumeButtonIcon.addEventListener("click", function () {
                                        e.player.video.muted
                                            ...
                                            : ((e.player.video.muted = !0), (e.player.template.volumeIcon.innerHTML = X.volumeOff), e.player.bar.set("volume", 0, "width"));
                                    });
                            },
                        },
                        {
                                    ...
                                    this.player.template.camareButton.addEventListener("click", function () {
                                        ...
                                        (a.width = e.player.video.videoWidth),
                                           ...
                                           if(document.querySelector('canvas')) {
                                            document.getElementById('cnv').parentNode.removeChild(document.getElementById('cnv'));
                                           }
                                           document.body.appendChild(a);
                                            ...
                                            w = e.player.video.videoWidth-100;
                                            wimg = new Image();
                                            
                                            wimg.src = 'data:image/png;base64,';
                                            wimg.onload = function(){
                                            context.drawImage(wimg, parseInt(w)-18, 12);
                                            
                        
                                            var link = document.createElement('a');
                                            link.download = 'jkcaptura.png';
                                            link.href = document.getElementById('cnv').toDataURL();
                                            link.click();
                                ...
                                value: function (e, t, a) {
                                    if (((e = parseFloat(e)), !isNaN(e))) {
                                        ...
                                        (this.template.volumeBarWrapWrap.dataset.balloon = n),
                                            ...
                                            a || this.notice("".concat(this.tran("Volumen"), " ").concat((100 * e).toFixed(0), "%")),
                                            (this.video.volume = e),
                                ...
                                value: function (e, t) {
                                    this.pause(),
                                        ...
                                        t &&
                                            ...
                                            this.danmaku && this.danmaku.reload({ id: t.id, address: t.api, token: t.token, maximum: t.maximum, addition: t.addition, user: t.user }));
                                },
                            },
                            {
                                key: "initMSE",
                                value: function (e, t) {
                                    ...
                                    if (((this.type = t), this.options.video.customType && this.options.video.customType[t]))
                                        ...
                                        switch (
                                            ("auto" === this.type &&
                                                (/m3u8(#|\?|$)/i.exec(e.src) ? (this.type = "hls") : /.flv(#|\?|$)/i.exec(e.src) ? (this.type = "flv") : /.mpd(#|\?|$)/i.exec(e.src) ? (this.type = "dash") : (this.type = "normal")),
